...
COLORS = {
    ...
    'Policy Focus': '#C27070',
    "Policy Category":'#C27070',
    "Renewable Energy Category": '#1E5631',
    'RE Focus':     '#1E5631',
}
SENTIMENT_COLORS = {
    'Negative': '#ffb3b3',
...
""", unsafe_allow_html=True)
    ...
    if not topic_density.empty:
        ...
        # ── Paste this block inside `with tab1:`, after the fig_density plotly_chart call ──
    ...
    if not non_outlier.empty:
        ...
        x_numeric = np.arange(len(monthly_adj))
